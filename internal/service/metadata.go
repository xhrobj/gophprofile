...
func (s *AvatarService) GetMetadata(ctx context.Context, avatarID string) (model.Avatar, error) {
...
func (s *AvatarService) ListByUserID(ctx context.Context, userID string) ([]model.Avatar, error) {
