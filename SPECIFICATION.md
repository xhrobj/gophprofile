# Техническое задание на Спринт 11
...
Создать HTTP-сервер на Go (Echo/Chi), подключить PostgreSQL для хранения метаданных и S3 (MinIO) для файлов. Реализовать эндпоинты для загрузки, получения и удаления аватарок, а также интегрировать готовый фронтенд.
